...
- README
- Testes mínimos
- CI/CD documentado e pronto para entrega final
- Fluxo padrão com GitLab CI, GitLab Runner e Harbor quando não houver exceção documentada
- Tratamento de erro
...
- Projeto final sem pipeline CI/CD definida

...
12. Avalie impacto em CI/CD, release e rollback.
13. Entregue resumo técnico.
...
- Prefira entrega final com pipeline CI/CD reproduzível.
- Prefira seguir GitLab CI + GitLab Runner + Harbor como padrão quando o projeto não definir outra tecnologia.
...
- Criar solução final sem considerar CI/CD.
